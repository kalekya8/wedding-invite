        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                    RsvpSubmissionId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GuestEventResponses_RsvpSubmissions_RsvpSubmissionId",
                        column: x => x.RsvpSubmissionId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GuestEventResponses_RsvpSubmissionId",
                table: "GuestEventResponses",
                column: "RsvpSubmissionId");
